								...
								.click(
										function() {
											...
											if (name == "") {
												...
												alert("완료");
												document.form1.action = "${path}Basket.do?command=CheckOut&total=${Total }";
...
<body>
	...
	<section class="checkout_area section_padding">
		<form class="row contact_form"
			action="Basket.do?command=CheckOut" method="post"
					...
					<div class="row">
						<div class="col-lg-8">
							...
							<div class="col-md-6 form-group p_star">
								<input type="hidden" name="id" value="<%=id%>"> <span><%=id%></span>
									<c:forEach var="List" items="${List}">
								<input type="hidden" name="num" value="${List.num}">
								<!-- 아직 구매전이고 장바구니 num을 보여줘야함 -->
								</c:forEach>
							</div>
							<div class="col-md-6 form-group p_star">
								<input type="text" class="form-control" name="name" /> <span
									class="placeholder" data-placeholder="name"></span>
							</div>
							<div class="col-md-6 form-group p_star">
							...
							<div class="col-md-6 form-group p_star">
								<input type="text" class="form-control" name="email" /> <span
							...
							<div class="col-md-12 form-group">
								...
								<textarea class="form-control" name="ordernote" id="message"
							...
							<div class="order_box">
								...
								<table class="table table-borderless">
									...
									<c:forEach var="List" items="${List}">
										...
										<tbody>
											<tr>
												<th colspan="2"><span>${List.title}</span></th>
												<th><span>${List.ssize}</span></th>
												<th><span>${List.color}</span></th>
												<th><span>${List.price}</span></th>
												<th><span>x${List.pcnt}</span></th>
												<c:set var="sum" value="${List.pcnt * List.price }" />
									...
									<tr>
										...
										<th><span><c:out value="${totalsum }"></c:out></span>
										<input type="hidden" value="${totalsum }" name="total"></th>	
									</tr>
									</tbody>
								</table>
							</div>
							<input type="submit" name="submit" class="btn_3">
						</div>
					</div>
				</div>
			</div>
