				...
				<div class="col-lg-12">
					<div class="breadcrumb_iner">
						<div class="breadcrumb_iner_item">
							<p>Home/Admin Page : Product List</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="cart_inner">
				<div class="table-responsive">
					<div class="checkout_btn_inner float-right"></div>
					<table class="table">
						<thead>
							<tr>
								<h2>Product Check List</h2>
							</tr>
							<tr>
						...
						<c:forEach var="AdminList" items="${AdminList}">
							<tbody>
								<tr>
									<td>
										<h5>${AdminList.pnum }</h5>
									</td>
									<td>
										<div class="media">
											<div class="d-flex">
												<img src="./img/${AdminList.pictureurl }" />
											</div>
										</div>
									</td>
									<td>
										<h5>${AdminList.title }</h5>
									</td>
									<td>
										<h5>${AdminList.pcnt }</h5>
									</td>
									<td>
										<h5>${AdminList.click }</h5>
									</td>
									<td>
										<h5>${AdminList.history }</h5>
									</td>
									<td>
										<h5>${AdminList.ssize }</h5>
									</td>
									<td>
										<h5>${AdminList.color }</h5>
									</td>
									<td>
										<h5>
										<c:set var="sum" value="${AdminList.pcnt - AdminList.history }"></c:set>
