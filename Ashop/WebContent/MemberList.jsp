						...
						<div class="order_details_iner">
							...
							<table class="table table-borderless">
								...
								<tbody>
									<tr>
										<th colspan="2"><span> <a
												href="Review.do?command=List&id=<%=id%>&pnum=${MList.pnum}">${MList.title}</a>
										</span></th>
										<th><span>${MList.ssize}</span></th>
										<th><span>${MList.color}</span></th>
										<th><span>${MList.price}</span></th>
										<th><span>x${MList.pcnt}</span></th>
										<c:set var="sum" value="${MList.pcnt *MList.price }" />
