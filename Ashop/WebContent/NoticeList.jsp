						...
						<table class="table table-borderless">
							...
							<c:forEach var="NList" items="${NList}">
								<tbody>
									<tr>
										<th colspan="2"><a
											href="Notice.do?command=NoticeDeatailList&nnum=${NList.nnum }"><span>${NList.nnum}</span></a></th>
										<th><span></span>${NList.ntype}</th>
										<th><span></span>${NList.ntitle}</th>
										<th><span><%=id%></span></th>
										<th><span>${NList.ndate}</span></th>
									</tr>
							</c:forEach>
							</tbody>
						</table>
