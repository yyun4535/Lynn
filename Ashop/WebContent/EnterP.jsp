...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#enterP").click(function() {
			var title = $("#title").val();
			var pictureurl = $("#pictureurl").val();
			var price = $("#price").val();
			var sort = $("#sort").val();
			var pcnt = $("#pcnt").val();
			var detailpic = $("#detailpic").val();
			var ssize = $("#ssize").val();
			var color = $("#color").val();
			...
			if (pictureurl == "") {
				...
				alert("Please, enter a sort");
			} else if (detailpic == "") {
				alert("Please, enter a detail-picture");
			} else if (ssize == "") {
				...
				alert("완료");
				document.form1.action = "${path}Padd.do?command=EnterP";
...
<body class="bg-white">
				...
				<div class="col-lg-12">
					<div class="breadcrumb_iner">
						<div class="breadcrumb_iner_item">
							<p>Home/Admin Page : EnterProducts
							<p>
						</div>
					</div>
				</div>
	...
	<!--================Single Product Area =================-->
	<form class="row contact_form" action="Padd.do?command=EnterP"
						...
						<div class="card_area">
							...
							<div class="product_count d-inline-block">
								...
								<input class="input-number" type="text" value="1" min="0"
									max="1000" name="pcnt" id="pcnt"> <span class="number-increment">
									<i class="ti-plus"></i>
								</span>
							</div>
							...
							<div class="s_product_text">
								<h3>DetailPicture</h3>
								<input type="file" name="detailpic" id="detailpic"/>
							</div>

							<div class="col-md-3 form-group p_star">
								<h3>Size</h3>
								<input type="text" name="ssize" id="ssize">
							...
							<div class="add_to_cart">
								<input type="submit" value="Submit" id="enterP">
							</div>
