				...
				<c:forEach var="NList" items="${NList}">
					<div class="col-lg-6 col-lx-4">
						<div class="single_confirmation_details">
							<h4>Notice Detail List</h4>
							<ul>
								<li>
									<p>num</p> <span>:${NList.nnum} </span>
								</li>
								<li>
									<p>Title</p> <span>: ${NList.ntitle}</span>
								</li>
								<li>
									<p>Content</p> <span>: ${NList.ncontent}</span>
								</li>
								<li>
									<p>Date</p> <span>: ${NList.ndate}</span>
								</li>
							</ul>
						</div>
					</div>
