					...
					<div class="order_details_iner">
						...
						<table class="table table-borderless">
							...
							<c:forEach var="OList" items="${OList}">
								<tbody>
									<tr>
										<th colspan="2"><span>${OList.title}</span></th>
										<th><span>${OList.ssize}</span></th>
										<th><span>${OList.color}</span></th>
										<th><span>${OList.price}</span></th>
										<th><span>x${OList.pcnt}</span></th>
									</tr>
							</c:forEach>
							</tbody>
						</table>
