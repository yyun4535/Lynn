				...
				<div class="col-lg-12">
					<div class="breadcrumb_iner">
						<div class="breadcrumb_iner_item">
							<p>Home/Admin Page : Notice Write
							<p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6">
					<div>
						<a href="Notice.do?command=Noticelist" class="btn_3">Notice
							All List<img src="./img/winter.PNG">
						</a>
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<div class="login_part_form">
						<div class="login_part_form_iner">
							<h3>Admin Notice Add</h3>
							<form class="row contact_form"
								action="Notice.do?command=Noticeadd" method="post"
								novalidate="novalidate">

								<div class="col-md-12 form-group p_star">
									<!--  -->
									<span class="col-md-12 form-group p_star">필독!</span><input
										type="radio" name="Ntype" placeholder="type" value="Important"><span
										class="col-md-12 form-group p_star">공지!</span><input
										type="radio" name="Ntype" placeholder="type" value="Notify">
									<span class="col-md-12 form-group p_star">★Event!★</span><input
										type="radio" name="Ntype" placeholder="type" value="Event">
								</div>
								...
								<div class="col-md-12 form-group p_star">
									<textarea name="Ncontent" class="form-control"
								...
								<div class="col-md-12 form-group p_star">
									...
									%>
									<input type="hidden" name="Ndate" value="<%=today%>">
								</div>
