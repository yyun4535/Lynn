					...
					<div class="row">
						<div class="col-lg-12">
							<div
								...
								<div class="Detail_menu product_bar_item">
									<h2>Bottom</h2>
								</div>
										...
										<div class="single_category_img">
											...
											<div class="category_social_icon">
												<ul>
													...
													<!-- Basket.do?command=Cartlist가 아닌 DB와 서블릿을 새로 생성하여 A링크 연결 -->
												</ul>
											</div>
											<div class="category_product_text">
												<a href="Padd.do?command=Detail&pnum=${List.pnum }">
													<h5>${sumlist}</h5>
													<h5>${List.title }</h5>
												</a>
												<p>${List.price }</p>
