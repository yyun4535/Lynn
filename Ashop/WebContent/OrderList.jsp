				...
				<div class="col-lg-12">
					<div class="breadcrumb_iner">
						<div class="breadcrumb_iner_item">
							<p>Home / Admin Page : All OrderList</p>
						</div>
					</div>
				</div>
			</div>
				...
				<c:forEach var="OList" items="${OList}">
					<div class="col-lg-6 col-lx-4">
						<div class="single_confirmation_details">
							<h4>Member's Order Info</h4>
							<ul>
								<li>
									<p>order number</p> <a
									href="Basket.do?command=OrderDetailList&buynum=${OList.buynum }"><span>:
											${OList.buynum}</span></a>
								</li>
								<%
									Date now = new Date();
								...
								<li>
									<p>ID</p> <span>: ${OList.id}</span>
								</li>
								<li>
									<p>Name</p> <span>: ${OList.name}</span>
								</li>
								<li>
									<p>Phone</p> <span>: ${OList.phone}</span>
								</li>
								<li>
									<p>Email</p> <span>: ${OList.email}</span>
								</li>
								<li>
									<p>OrderNote</p> <span>: ${OList.ordernote}</span>
								</li>
								<li>
									<p>Address</p> <span>: ${OList.address }</span>
								</li>
							</ul>
						</div>
					</div>
